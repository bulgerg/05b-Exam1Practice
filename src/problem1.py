...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -0.2013  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([5, 10], expected, test_results,
                                  format_string)
    actual = problem1a(5, 10)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    # Test 4:
    expected = -0.2296  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([40, 100], expected, test_results,
                                  format_string)
    actual = problem1a(40, 100)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
